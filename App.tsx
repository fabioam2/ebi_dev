...
const App: React.FC = () => {
    // Lê o ID da instância a partir do "hash" da URL (ex: #/inst-123)
    // Isso remove o "#" ou "#/" do início, deixando apenas o ID.
    const instanceId = window.location.hash.replace(/^#\/?/, '');
    ...
    // Se não houver ID no hash, mostra a página de criação/seleção.
    if (!instanceId) {
